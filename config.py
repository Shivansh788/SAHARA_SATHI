...
COEAI_API_KEY = os.environ.get("COEAI_API_KEY", "")
...
GEMINI_TIMEOUT_SEC = _env_float("GEMINI_TIMEOUT_SEC", 20.0)

DATA_GOV_PROVIDER = os.environ.get("DATA_GOV_PROVIDER", "auto").strip().lower()
DATA_GOV_API_KEY = os.environ.get("DATA_GOV_API_KEY", "")
DATA_GOV_RAPIDAPI_KEY = os.environ.get("DATA_GOV_RAPIDAPI_KEY", "")
...
OLLAMA_READ_TIMEOUT_SEC = _env_float("OLLAMA_READ_TIMEOUT_SEC", 10.0)
